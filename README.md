...
hotelier@oceanic-archery-426908-g9.iam.gserviceaccount.com

gcloud beta services identity create --service=aiplatform.googleapis.com --project=oceanic-archery-426908-g9
...
https://us-central1-aiplatform.googleapis.com/v1/projects/oceanic-archery-426908-g9/locations/us-central1/publishers/google/models/gemini-1.5-flash-001:streamGenerateContent -d \
$'{
  "contents": {
    "role": "user",
    "parts": [
...
gcloud config set project oceanic-archery-426908-g9